...
class TradingSettings(BaseModel):
    ...
    # Active platforms (3 MT5 Accounts)
    active_platforms: List[Literal["MT5_LIBERTEX_DEMO", "MT5_ICMARKETS_DEMO", "MT5_LIBERTEX_REAL"]] = ["MT5_LIBERTEX_DEMO", "MT5_ICMARKETS_DEMO"]  # Default: Beide MT5 aktiv
    mode: Optional[str] = None  # Deprecated, kept for backward compatibility
